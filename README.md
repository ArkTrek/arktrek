...
🔭 **Current Focus & Architectures:** * **AI Agency Agent:** Building an autonomous agentic tool utilizing the Gemini API to automatically generate custom webpages for local businesses.
* **Script Gen AI:** Developing a professional Flask-based hub that structures and optimizes prompts for Generative AI video projects (Google Veo, Wan 2.2).
* **Theyyam Detection System:** Architected a custom cultural preservation system using a hybrid CNN+RNN architecture for real-time classification.
* **Brain Disease Detection (BDDS):** Engineered a deep CNN model for predicting diseases like Alzheimer's and Tumors using MRI images, achieving 98% accuracy.

🌱 **Learning Journey:** Transitioning from traditional machine learning deployments to orchestrating **autonomous AI agents**, **LLM RAG pipelines**, and multi-step generative workflows.

🤝 **Open to Collaboration:** Always excited to team up on Generative AI pipelines, computer vision models, and full-stack agentic applications!

💬 **Ask Me About:** Deep Learning, Generative AI (Images/Video), Python (Flask), prompt engineering, and digital storytelling.
